...
impl<R: CubeRuntime, F: FloatElement, I: IntElement, BT: BoolElement> MatmulAddReluBackend
...
mod fusion_impl {
    ...
    impl<B: FusionBackend + MatmulAddReluBackend> MatmulAddReluBackend for Fusion<B> {
        fn fused_matmul_add_relu(inputs: MatmulAddReluPrimitiveInputs<Self>) -> FloatTensor<Self> {
